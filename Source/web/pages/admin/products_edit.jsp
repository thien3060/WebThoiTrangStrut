                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content">
                            <div id="home" class="tab-pane fade in active" style="margin-top: 15px;">
                                <s:form action="editproduct" class="form-horizontal" method="get">
                                    <input class="form-control hidden" name="productId"  type="text" value="<s:property value="product_edit.productId"/>"/>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Product Name</label>
                                        <div class="col-sm-10">
                                            <input name="productName" value="<s:property value="product_edit.productName"/>" type="text" class="form-control" placeholder="Product Name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="unit" value="<s:property value="product_edit.unit"/>" type="text" class="form-control" placeholder="Unit">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="price" value="<s:property value="product_edit.price"/>" type="text" class="form-control" placeholder="Price">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="stock" value="<s:property value="product_edit.stock"/>" type="text" class="form-control" placeholder="Stock">
                                        </div>
                                    </div>
                                    ...
                                    <table id="images" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <s:iterator value="listImage">
                                                <tr>
                                                    <td class="text-center"><img class="img-thumbnail" style="height: 50px; width: 50px" src="<s:property value="url"/>"/>
                                        ...
                                        <tfoot>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td class="text-left"><button type="button" onclick="location = uploadImage" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add Image"><i class="fa fa-plus-circle"></i></button></td>
                                        </tfoot>
                                    </table>
                                </div>
                            </div>
